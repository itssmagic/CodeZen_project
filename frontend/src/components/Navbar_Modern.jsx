...
import { ArrowRightEndOnRectangleIcon, ArrowRightIcon, Bars3Icon, BellIcon, UserIcon, XMarkIcon } from "@heroicons/react/24/outline";
                                ...
                                <Menu as="div" className="relative ml-3">
                                    <div>
                                        <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                            ...
                                            /> */}
                                            <div className="h-8 w-8 bg-slate-400 uppercase rounded-full text-lg items-center justify-center flex">{user?.username[0]}</div>
                                        </MenuButton>
                                    </div>
                                    <MenuItems
                                        transition
